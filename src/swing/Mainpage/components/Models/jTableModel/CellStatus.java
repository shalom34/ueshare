...
public class CellStatus extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        status = new swing.Mainpage.components.Models.jTableModel.TableStatus();

        setBackground(new java.awt.Color(255, 255, 255));

        status.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        status.setText("Status");
        status.setFont(new java.awt.Font("Yu Gothic UI", 0, 14)); // NOI18N
    ...
    private swing.Mainpage.components.Models.jTableModel.TableStatus status;
